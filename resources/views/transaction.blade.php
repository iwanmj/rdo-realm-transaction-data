...
<header class="navbar navbar-primary sticky-top bg-primary flex-md-nowrap p-0 shadow">
  <a class="navbar-brand text-light col-md-3 col-lg-2 me-0 px-3" href="#">Realm Transaction</a>
...
<div class="container-fluid">
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="alert alert-primary alert-info" style="display:none;" role="alert">
